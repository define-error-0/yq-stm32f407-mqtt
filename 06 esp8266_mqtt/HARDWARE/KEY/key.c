...
void key_init(void)
{
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY;				//抢占优先级 0x05
...
uint32_t key_sta_get(uint8_t datatmp)
{
	uint32_t key_sta=0;
...
void EXTI2_IRQHandler(void)
{
	...
	{
		xEventGroupSetBitsFromISR(g_event_group,EVENT_GROUP_KEY2_DOWN,NULL);
...
void EXTI3_IRQHandler(void)
{
	...
	{
		xEventGroupSetBitsFromISR(g_event_group,EVENT_GROUP_KEY3_DOWN,NULL);
...
void EXTI4_IRQHandler(void)
{
	...
	{
		xEventGroupSetBitsFromISR(g_event_group,EVENT_GROUP_KEY4_DOWN,NULL);
